<template>
  <div class="image-box" :style="{ height }">
    <div class="flex aic mb-4">
      <el-input v-model="image_url" class="f1" placeholder="网络地址" @keyup.native.enter="urlImageChange">
      </el-input>
      <el-upload class="upload-box" drag :limit="limit" :show-file-list="false" :on-success="handleUploadSuccess"
