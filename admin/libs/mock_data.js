const admin_mock_data = {
  select_data: {
    ...
    tab_type_list: [{ label: '模型体验', value: 'experience' }, { label: '官网模型体验', value: 'web_experience' }, { label: '热门', value: 'hot' }, { label: '文字创作', value: 'write' }, { label: '绘画', value: 'image' }],
    type_list: [{ value: 'text', label: '文字创作' }, { value: 'image', label: '绘图应用' }, { value: 'video', label: '视频应用' }, { value: 'music', label: '音乐应用' }],
    nav_type: [{ value: '', label: '默认' }, { value: 'H5', label: 'H5' }, { value: 'chatWrite', label: '文案chat' }, { value: 'application', label: 'application设置' }, { value: 'miniprogram', label: '小程序' }, { value: 'H5-OPEN', label: '外部H5' }],
    status: [{ label: '待审核', value: 0 }, { label: '审核中', value: 2 }, { label: '已通过', value: 1 }, { label: '已拒绝', value: 3 }],
    result_status: [{ label: '进行中', value: 0 }, { label: '完成', value: 1 }, { label: '失败', value: -1 },],
    limit_type: [{ label: '看视频或开会员', value: '1' }, { label: '开会员', value: '2' }],
    platform: [{ label: '全平台', value: 'ALL' }, { label: '官网', value: 'WEB' }, { label: 'APP', value: 'APP' }, { label: 'H5', value: 'H5' }, { label: '全部小程序', value: 'MP' }, { label: '抖音小程序', value: 'MP-TOUTIAO' }, { label: '微信小程序', value: 'MP-WEIXIN' },],
    equity_card_type: [{ label: '会员卡', value: 'member' }, { label: '视频权益卡', value: 'video' }],
    handle_status: [{ label: '待处理', value: 0 }, { label: '已处理', value: 1 },],
    permission_type: [{ label: '功能权限', value: 'func', }, { label: '页面权限', value: 'page' }],
    equity_time: [{ label: '周卡', value: 604800000 }, { label: '月卡', value: 2592000000 }, { label: '季卡', value: 7776000000 }, { label: '年卡', value: 31104000000 },]
  },
  user_list: [
    "63a9aa648d766d5be9654893",
    "63e258eac00f1f29623c93f7",
    "641ab9b09c3cf57aeafda648",
    "644797b27cd5773a6d4f428d",
    "646592fc5e6bb82b8cc783d4",
    "64756728b5420e27679c7e74",
    "647d4a91b5420e2767f5d2fd",
    "6487151013321e41d56ced09",
    "6487f32fd3737519766d40c4",
    "648fd7fe33d9bd7ea289a500",
    "6498cdca2f4bf42bd9f99c59",
    "649bc2062f4bf42bd904fbfb",
    "649fae692f4bf42bd9134a4f",
    "64a506139ae3847a63ced0b7",
    "64a6ada85d666b1e29c1c101",
    "64aa7f8635ca1922ea3d5500",
    "64ba4d082f4bf42bd9769382",
  ]
}